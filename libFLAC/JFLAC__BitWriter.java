...
final class JFLAC__BitWriter {
	...
	*/
	...
	private final boolean FLAC__bitwriter_write_raw_uint32_nocheck(final int val, final int nbits)
	{
	...
	final boolean FLAC__bitwriter_write_raw_uint32(final int val, final int bits)
	{
	...
	final boolean FLAC__bitwriter_write_raw_int32(int val, final int nbits)
	{
		...
		return FLAC__bitwriter_write_raw_uint32_nocheck( val, nbits );
	}
	...
	public final boolean FLAC__bitwriter_write_raw_uint64(final long val, final int nbits)
	{
		...
		if( nbits > 32 ) {
			return
				...
				FLAC__bitwriter_write_raw_uint32_nocheck( (int)val, 32 );
		}// else {
	...
	final boolean FLAC__bitwriter_write_raw_uint32_little_endian(final int val)
	{
		...
		if( ! FLAC__bitwriter_write_raw_uint32_nocheck( val >>> 24, 8 ) ) {
			return false;
		}
	...
	final boolean FLAC__bitwriter_write_byte_block(final byte vals[], final int nvals)
	{
		...
		for( int i = 0; i < nvals; i++ ) {
			if( ! FLAC__bitwriter_write_raw_uint32_nocheck( vals[i] & 0xff, 8 ) ) {
				return false;
			}
		}
	...
	final boolean FLAC__bitwriter_write_unary_unsigned(int val)
	{
		if( val < 32 ) {
			...
			return
				...
				FLAC__bitwriter_write_raw_uint32_nocheck( 1, 1 );
		//}
	}
...
//#endif /* UNUSED */
	...
	public final boolean FLAC__bitwriter_write_utf8_uint32(final int val)
	{
		...
		if( (val & 0xffffff80) == 0 ) {// if( val < 0x80 )
			return FLAC__bitwriter_write_raw_uint32_nocheck( val, 8 );
		}
	...
	public final boolean FLAC__bitwriter_write_utf8_uint64(final long val)
	{
		...
		if( (val & 0xffffffffffffff80L) == 0 ) {// if( val < 0x80 )
			return FLAC__bitwriter_write_raw_uint32_nocheck( ival, 8);
		}
		else if( (val & 0xfffffffffffff800L) == 0 ) {// if( val < 0x800 )
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0xC0 | (ival >>> 6), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | (ival & 0x3F), 8 );
		}
		else if( (val & 0xffffffffffff0000L) == 0 ) {// if( val < 0x10000 )
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0xE0 | (ival >>> 12), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 6) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | (ival & 0x3F), 8 );
		}
		else if( (val & 0xffffffffffe00000L) == 0 ) {// if( val < 0x200000 )
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0xF0 | (ival >>> 18), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 12) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 6) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | (ival & 0x3F), 8 );
		}
		else if( (val & 0xfffffffffc000000L) == 0 ) {// if( val < 0x4000000 )
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0xF8 | (ival >>> 24), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 18) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 12) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 6) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | (ival & 0x3F), 8 );
		}
		else if( (val & 0xffffffff80000000L) == 0 ) {// if( val < 0x80000000 )
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0xFC | (int)(val >>> 30), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 24) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 18) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 12) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 6) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | (ival & 0x3F), 8 );
			...
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | (int)((val >>> 30) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 24) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 18) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 12) & 0x3F), 8 );
			ok &= FLAC__bitwriter_write_raw_uint32_nocheck( 0x80 | ((ival >>> 6) & 0x3F), 8 );
