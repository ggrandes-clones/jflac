 ...
 */
public final class JFLAC__StreamMetadata_Picture extends JFLAC__StreamMetadata {
	static final String MIME_ENCODING = "US-ASCII";
	static final String DESCRIPTION_ENCODING = "UTF-8";

	/** The kind of picture stored. */
	int /* FLAC__StreamMetadata_Picture_Type */ picture_type = Jformat.FLAC__STREAM_METADATA_PICTURE_TYPE_UNDEFINED;// type is hiding the type field from type JFLAC__StreamMetadata, renamed to picture_type
	...
	JFLAC__StreamMetadata_Picture() {
		super.type = Jformat.FLAC__METADATA_TYPE_PICTURE;
	}

	JFLAC__StreamMetadata_Picture(final JFLAC__StreamMetadata_Picture m) {
		super( m );
	...
	static boolean compare_block_data_picture_(final JFLAC__StreamMetadata_Picture block1, final JFLAC__StreamMetadata_Picture block2)
	{
		...
		if( block1.data != block2.data && (block1.data == null || block2.data == null || 0 != Jformat.memcmp( block1.data, 0, block2.data, 0, block1.data_length )) ) {
			return false;
		}
		return true;
	}

	public final boolean FLAC__metadata_object_picture_set_mime_type(final String mime, final boolean copy)
	{
		...
		if( new_length > Jformat.SIZE_MAX ) {
			return false;
		}
	...
	public final boolean FLAC__metadata_object_picture_set_description(final String pic_description, final boolean copy)
	{
		//FLAC__ASSERT(object != NULL);
		//FLAC__ASSERT(object->type == FLAC__METADATA_TYPE_PICTURE);
	...
	public final boolean FLAC__metadata_object_picture_set_data(final byte[] d, final int size, final boolean copy)
	{
		//FLAC__ASSERT(object != NULL);
		//FLAC__ASSERT(object->type == FLAC__METADATA_TYPE_PICTURE);
	...
	public final String /* boolean */ FLAC__metadata_object_picture_is_legal(/* const char **violation*/)
	{
		//FLAC__ASSERT(object != NULL);
		//FLAC__ASSERT(object->type == FLAC__METADATA_TYPE_PICTURE);

		return FLAC__format_picture_is_legal( /*, violation*/ );
	}

	/* @@@@ add to unit tests; it is already indirectly tested by the metadata_object tests */
	/** @return null if legal, String if not legal */
	public final String FLAC__format_picture_is_legal()//, final String[] violation)
	{
