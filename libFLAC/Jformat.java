...
public final class Jformat {
	 ...
	 */
	public static final String FLAC__VERSION_STRING = "1.3.2";

	/** The vendor string inserted by the encoder into the VORBIS_COMMENT block.
	 *  This is a NUL-terminated ASCII string; when inserted into the
	 *  VORBIS_COMMENT the trailing null is stripped.
	 */
	public static final String FLAC__VENDOR_STRING = "reference libFLAC " + FLAC__VERSION_STRING + " 20170101";
	 ...
	 * ilog2(18) = 4
	 */
	static int FLAC__bitmath_ilog2(int v)
	{
		int l = 0;
		//FLAC__ASSERT(v > 0);
		while( (v >>>= 1) != 0 ) {
	...
	/* FIXME never used
	static int FLAC__bitmath_ilog2_wide(long v)
	{
		int l = 0;
		//FLAC__ASSERT(v > 0);
		while( (v >>>= 1) != 0 )
	...
	*/
	 ...
	 */
	/* FIXME never used
	static int FLAC__bitmath_silog2(long v)
	{
		if( v == 0 )
			return 0;
		if( v == -1 )
	...
	*/
	...
	public static boolean FLAC__format_sample_rate_is_valid(final int sample_rate)
	{
	...
	public static boolean FLAC__format_blocksize_is_subset(final int blocksize, final int sample_rate)
	{
		if( blocksize > 16384 ) {
			return false;
	...
	public static boolean FLAC__format_sample_rate_is_subset(final int sample_rate)
	{
		if(
	...
	/*private static int seekpoint_compare_(final JFLAC__StreamMetadata_SeekPoint l, final JFLAC__StreamMetadata_SeekPoint r)
	{// moved to JFLAC__StreamMetadata_SeekPoint as Comparable interface
	...
	public static final boolean FLAC__format_vorbiscomment_entry_name_is_legal(final byte[] name)
	{
		char c;
		for( c = *name; c; c = *(++name) )
	...
	public static final boolean FLAC__format_vorbiscomment_entry_value_is_legal(final FLAC__byte *value, unsigned length)
	{
	...
	public static final boolean FLAC__format_vorbiscomment_entry_is_legal(final FLAC__byte *entry, unsigned length)
	{
