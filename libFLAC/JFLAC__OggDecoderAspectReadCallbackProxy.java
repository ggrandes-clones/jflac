...
interface JFLAC__OggDecoderAspectReadCallbackProxy {
     ...
     */
	int ogg_read_callback(final Object decoder, byte buffer[], int offset, int bytes/*, Object client_data*/) throws IOException;
}
